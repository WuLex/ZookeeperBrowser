...
{
    public class AuthInfoService : BaseService<AuthInfoEntity, AuthInfoDTO, int>, IAuthInfoService, IDependency
    {
        ...
        /// 更新账户认证信息
        /// </summary>
        private async Task<LoginResultModel> UpdateAuthInfo(AccountEntity account, LoginModel model)
        {
            var accountDTO = _mapper.Value.Map<AccountDTO>(account);
